...
namespace StarterAssets
{
    ...
    public class ThirdPersonController : MonoBehaviour
    {
        ...
        private void setAimShoot(bool aiming, bool shooting)
        {
        ...
        {
            // Make the camera focus on the arrow point
            if (isAiming)
                playerAimCamera.transform.LookAt(arrowPoint);
        ...
        private void AimShoot()
        {
            ...
            {
                setAimShoot(_input.isAiming, _input.isShooting);
                setCamera(_input.isAiming);
            }
            else{
                setAimShoot(false, false);
                setCamera(false);
            }
        }
        ...
        //check if collide with tag winning gate
